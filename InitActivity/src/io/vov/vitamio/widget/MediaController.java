...
public class MediaController extends FrameLayout {
    ...
    private Handler mVideoPlaperHandler;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case BACK:
                    ...
                    break;
                case HIGH_QUALITY:
                    // TODO: 16/3/6  切换普清与高清,记录播放位置
                    message.what = 0x2;
                    pos = mPlayer.getCurrentPosition();
                    message.obj = pos;
                    Log.d(">>>>>高清pos:" + String.valueOf(pos));
                    mVideoPlaperHandler.sendMessage(message);
                    break;
                case LOW_QUALITY:
                    // TODO: 16/3/6  切换普清与高清,记录播放位置
    ...
    //高清
    private OnClickListener mHighQualityListener = new OnClickListener() {
        @Override
        public void onClick(View v) {
            mHandler.sendEmptyMessage(HIGH_QUALITY);
        }
    };

    //普清
    private OnClickListener mLowQualityListener = new OnClickListener() {
        @Override
        public void onClick(View v) {
            mHandler.sendEmptyMessage(LOW_QUALITY);
        }
    };
    ...
    private OnSeekBarChangeListener mSeekListener = new OnSeekBarChangeListener() {
        ...
        public void onProgressChanged(SeekBar bar, int progress, boolean fromuser) {
            ...
            Log.e(">>>>>onProgressChanged+newposition:" + newposition);
    ...
    private void initControllerView(View v) {
        ...
        mBackButton = (ImageButton) v.findViewById(getResources().getIdentifier("back", "id", mContext.getPackageName()));
        if (null != mBackButton) {
            mBackButton.setOnClickListener(mBackListener);
        }
        mHighQualityButton = (ImageButton) v.findViewById(getResources().getIdentifier("high_quality", "id", mContext.getPackageName()));
        if (null != mHighQualityButton) {
            mHighQualityButton.setOnClickListener(mHighQualityListener);
        }
        mLowQualityButton = (ImageButton) v.findViewById(getResources().getIdentifier("low_quality", "id", mContext.getPackageName()));
