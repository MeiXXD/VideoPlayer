...
public class VideoView extends SurfaceView implements MediaController.MediaPlayerControl {
    ...
    OnPreparedListener mPreparedListener = new OnPreparedListener() {
        public void onPrepared(MediaPlayer mp) {
            ...
            Log.d(">>>>>mSeekWhenPrepared:" + mSeekWhenPrepared);
            long seekToPosition = mSeekWhenPrepared;
            //long seekToPosition = 30000;
            //两次才行
            if (seekToPosition != 0)
    ...
    private OnSeekCompleteListener mSeekCompleteListener = new OnSeekCompleteListener() {
        ...
        public void onSeekComplete(MediaPlayer mp) {
            Log.d(">>>>>onSeekComplete  getCurrentPosition:" + getCurrentPosition());
    ...
    public void changeDefinitionAndResume(long time) {
        if (mUri == null || mSurfaceHolder == null)
            return;
        try {
            Log.d(">>>>>changeDefinition+setDataSource");
            //            mMediaPlayer.reset();
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//            }
    ...
    public long getCurrentPosition() {
        Log.d(">>>>>getCurrentPosition:" + String.valueOf(mMediaPlayer.getCurrentPosition()));
        if (isInPlaybackState())
